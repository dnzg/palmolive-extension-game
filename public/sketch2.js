...
function preload() {
	spaceShipImg = loadImage('assets2/spaceShip.png');
	bulletImg = loadImage('assets2/bullet.png');
	bulletEnemyImg = loadImage('assets2/bullet2.png');
	enemyImg1 = loadImage('assets2/enemy1.png');
	enemyImg1b = loadImage('assets2/enemy1b.png');
	enemyImg2 = loadImage('assets2/enemy2.png');
	enemyImg3 = loadImage('assets2/enemy3.png');
	myFont = loadFont('assets2/8-bit-pusab.ttf');
	for (let i = 1; i<7; i++) {
		explosionAnim.push(loadImage('assets2/expl'+i+'.png'));
	}
	bonusImg[0] = loadImage('assets2/bonus0.png');
	bossImg[0] = loadImage('assets2/boss0.png');
